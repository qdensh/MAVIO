...
/*
  ...
  *    the feature's 3d position using only two views.
  * @param T_c1_c2: A rigid body transformation taking
  *    a vector from c2 frame to c1 frame.            T_c1i_c00
  * @param z1: feature observation in c1 frame.       z00
  * @param z2: feature observation in c2 frame.       z1i
  * @return p: Computed feature position in c1 frame. p00
  */
